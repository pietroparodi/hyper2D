module global_module
   ...
   ENUM, BIND(C)
      ENUMERATOR FIXED_RATE, ARRHENIUS, HARD_SPHERE, TABULATED
   END ENUM
   ...
   TYPE REACTIONS_DATA_STRUCTURE
      ...
      INTEGER :: P3_SP_ID
      INTEGER :: P4_SP_ID
      REAL(KIND=8) :: A, N, TA, ER, DIAM, CONSTANT_RATE
      REAL(KIND=8), DIMENSION(6) :: DELTAE
      INTEGER :: N_PROD
      REAL(KIND=8), DIMENSION(:), ALLOCATABLE :: TABLE_TEMP
      REAL(KIND=8), DIMENSION(:), ALLOCATABLE :: TABLE_RATE
   ...
   ENUM, BIND(C)
      ENUMERATOR AUSM, HLL, SLAU, CENTRAL
   END ENUM
